...
public:
    ...
    Account(string holder, int accNum, double initialBal, int p) {
...
public:
    ...
    ATM(string holder, int accNum, double initialBal, int p) 
        : Account(holder, accNum, initialBal, p) {}
...
int main() {
    ...
    // Create account dynamically with user input
    ...
    ATM user(name, accNum, initialBal, pin);

    // Authenticate before allowing menu access
    int enteredPin;
    int attempts = 3;
